...
export default function Game() {
  ...
  useEffect(() => {
    ...
    setQuestions([
      ...
      {
        category: "Misc",
        question: "This was the first US President",
      ...
      {
        category: "Misc",
        question: "This is the shape generally used for stop signs",
        answer: "Octagon",
        point_value: "Easy",
        asked: false,
      },
      {
        category: "Misc",
        question: "These are the colors on a rainbow",
      ...
      {
        category: "Misc",
        question: "Inside of a web browser, WWW stands for this",
      ...
      {
        category: "Misc",
        question: "This was the first woman to fly solo across the Atlantic",
      ...
      {
        category: "Misc",
        question: "This is the biggest South Korean technology company",
        answer: "Samsung",
        point_value: "Very Hard",
        asked: false,
      },
      {
        category: "Misc",
        question: "This was the first soft drink in space",
        answer: "Coca-Cola",
        point_value: "Super Duper Hard",
        asked: false,
      },
